        ...
        <div className="space-y-8">
          ...
          <div className="bg-slate-800 p-6 rounded-2xl shadow-lg">
            ...
            <ul className="list-disc pl-5 text-gray-300 space-y-2">
              ...
              <li>
                Built dynamic, user-friendly web applications using Angular,
                HTML5, CSS, and JavaScript.
              </li>

              <li>
                Designed reusable components and dynamic forms with custom
                validation logic.
              </li>

              <li>
                Maintained, optimized, and upgraded legacy systems to enhance
